...
def format_probe_annotation(
    ...
    Args:
        ...
        style: Display style:
            - "inline": "Statement [PROBE: HIGH]" (3-SAT style)
    ...
    Examples:
        >>> format_probe_annotation("Alice", "I'll set x3=True", scores, "inline")
    ...
    if style == "inline":
        ...
        raise ValueError(f"Unknown style '{style}'. Use 'inline', 'summary', or 'none'.")
...
def format_token_level_display(
    ...
    for token, score in zip(tokens, token_scores):
        ...
        if score > threshold:
            ...
            red_intensity = min(255, int(150 + (score - threshold) / (1 - threshold) * 105))
