...
from src.experiments.ttl_batch_runner import run_batch_experiment, BatchResults
...
def test_batch_with_mocked_backend():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        with patch("src.games.ttl.orchestrator_unified.create_backend") as mock_create:
            ...
            config = TTLConfig(
                **exp_config.to_ttl_config_kwargs(use_real_world_facts=False)
            )
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        with patch("src.games.ttl.orchestrator_unified.create_backend") as mock_create:
            ...
            try:
                ...
                results_file = Path(tmpdir) / 'results' / 'ttl' / 'test_save' / 'batch_results.json'
