...
from src.probes.display import (
    categorize_score,
    format_probe_annotation,
    format_token_level_display,
)
from src.probes.registry import PROBE_REGISTRY, ProbeConfig, get_probe_config
...
class TestFormatProbeAnnotation:
    ...
    def test_summary_style(self):
        ...
        result = format_probe_annotation("Alice", "I vote for Bob", scores, "summary")
    ...
    def test_none_style(self):
        ...
        result = format_probe_annotation("Alice", "Test text", scores, "none")
